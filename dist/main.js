...
var routes = [
    ...
    {
        path: 'login',
        loadChildren: function () { return Promise.all(/*! import() | login-login-module */[__webpack_require__.e("default~login-login-module~pages-admin-admin-module~pages-dashboard-dashboard-module~pages-report-re~789aeffa"), __webpack_require__.e("default~layout-layout-module~login-login-module"), __webpack_require__.e("login-login-module")]).then(__webpack_require__.bind(null, /*! ./login/login.module */ "./src/app/login/login.module.ts")).then(function (m) { return m.LoginModule; }); }
    }
];
...
module.exports = __webpack_require__(/*! /Users/narendrachauhan/Desktop/sb-admin-material-master/src/main.ts */"./src/main.ts");
